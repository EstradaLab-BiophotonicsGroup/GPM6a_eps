# -*- coding: utf-8 -*-
"""
Created on Wed Sep 18 11:53:24 2024
...
data = [list(Epsilon_GPM6a_3[0:8]/np.mean(Epsilon_GPM6a_3[0:8]))+
        list(Epsilon_GPM6a_3[8::]/np.mean(Epsilon_GPM6a_3[8::])),
        list(Epsilon_M_154_V[0:4]/np.mean(Epsilon_GPM6a_3[0:8]))+
        list(Epsilon_M_154_V[4::]/np.mean(Epsilon_GPM6a_3[8::]))]
...
data = [list(Epsilon_GPM6a_3[0:8]/np.mean(Epsilon_GPM6a_3[0:8]))+
        list(Epsilon_GPM6a_3[8::]/np.mean(Epsilon_GPM6a_3[8::])),
        list(Epsilon_F_156_Y[0:5]/np.mean(Epsilon_GPM6a_3[0:8]))+
        list(Epsilon_F_156_Y[5::]/np.mean(Epsilon_GPM6a_3[8::]))]
